...
st.markdown("""
            # About Us
        The mission is to help students along their academic journey and expand the scope of education through using Artificial Intelligence and experienced counselors. 

        ## College Prep Head Counselor
